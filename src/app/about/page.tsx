...
export default function AboutPage() {
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-black text-white selection:bg-emerald-500/30">
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-4xl mx-auto">
                        <div className="about-hero-anim inline-block mb-4 px-4 py-1.5 rounded-full bg-zinc-900/80 border border-zinc-800 text-emerald-400 text-xs font-bold tracking-widest uppercase">
                            Our Story
                        </div>
                        <h1 className="about-hero-anim text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-[0.9]">
                        ...
                        <div className="about-hero-anim space-y-6 text-lg md:text-xl text-zinc-400 leading-relaxed max-w-2xl mx-auto">
                            <p>
            ...
            <section className="py-24 bg-zinc-900/30 reveal-section">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-sm font-bold text-emerald-500 uppercase tracking-widest mb-3">Why Us</h2>
                        <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">What Makes Us Different</h3>
                        <p className="text-xl text-zinc-400">We built a platform that works for everyone in the game.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Card 1 */}
                        <div className="bg-black border border-zinc-800 p-10 rounded-3xl hover:border-emerald-500/30 transition-colors group">
                            <div className="w-14 h-14 bg-zinc-900 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                <MapPin className="w-7 h-7 text-emerald-400" />
                            </div>
                            <h4 className="text-2xl font-bold text-white mb-4">Island-Wide Access</h4>
                        ...
                        <div className="bg-black border border-zinc-800 p-10 rounded-3xl hover:border-emerald-500/30 transition-colors group">
                            ...
                            <h4 className="text-2xl font-bold text-white mb-4">Empowering Centers</h4>
                            <p className="text-zinc-400 leading-relaxed">
            ...
            <section className="pb-32 pt-10 reveal-section">
                <div className="container mx-auto px-4">
                    <div className="rounded-3xl bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 p-12 md:p-20 text-center relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-transparent" />

                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-8">Ready to Get in the Game?</h2>

                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Button href="/venues" className="w-full sm:w-auto px-10 py-4 text-lg font-bold">
                                Explore Venues
                            </Button>
                            <Button href="/partner" className="w-full sm:w-auto px-10 py-4 text-lg font-bold bg-transparent border border-zinc-700 hover:bg-zinc-800 text-white">
                                List Your Venue
                            </Button>
                        </div>
                    </div>
