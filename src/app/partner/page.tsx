...
export default function PartnerPage() {
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-black text-white">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="absolute inset-0 z-0 opacity-40">
                    <div className="w-full h-full bg-zinc-900 border border-zinc-800 flex items-center justify-center">
                        <div className="text-zinc-700 font-bold text-2xl uppercase tracking-widest animate-pulse">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl">
                    <div className="hero-text-anim inline-block mb-4 px-4 py-1.5 rounded-full bg-zinc-900/80 border border-zinc-800 text-emerald-400 text-sm font-medium tracking-wide uppercase">
                        For Venue Owners
                    </div>
                    <h1 className="hero-text-anim text-5xl md:text-8xl font-black text-white mb-8 tracking-tighter leading-[0.9]">
                        TURN EMPTY SLOTS <br />
                        INTO <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">REVENUE</span>
                    </h1>
                    <p className="hero-text-anim text-lg md:text-2xl text-zinc-400 max-w-3xl mx-auto mb-10 leading-relaxed">
                    ...
                    <div className="hero-text-anim flex flex-col md:flex-row items-center justify-center gap-4">
                        ...
                        <Button href="#features" className="w-full md:w-auto px-8 py-4 text-lg font-bold bg-transparent border border-zinc-700 hover:bg-zinc-900 text-white">
                            Explore Features
                        </Button>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="relative aspect-video rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-2xl shadow-emerald-900/20 group">
                                <div className="absolute inset-0 flex items-center justify-center text-zinc-600 font-bold text-lg uppercase group-hover:text-emerald-500 transition-colors">
            ...
            <section className="py-24 md:py-32 relative bg-zinc-900/30 reveal-section">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        {/* Visual/Video Placeholder */}
                        <div>
            ...
            <section className="py-24 md:py-32 reveal-section">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Complete Feature Set</h2>
                        <p className="text-xl text-zinc-400">Everything you need to run your sports business efficiently.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, i) => (
                            <div key={i} className="group p-8 rounded-2xl bg-zinc-900/40 border border-zinc-800/50 hover:bg-zinc-900 hover:border-emerald-500/30 transition-all duration-300">
                                <div className="h-12 w-12 rounded-xl bg-zinc-800 flex items-center justify-center mb-6 group-hover:bg-emerald-500/20 group-hover:scale-110 transition-all duration-300">
            ...
            {/* 5. STEPS SECTION */}
            <section className="py-24 md:py-32 bg-zinc-900/30 reveal-section">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Get Started in 3 Steps</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        {/* Connector Line (Desktop) */}
                        <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5 bg-gradient-to-r from-zinc-800 via-emerald-500/50 to-zinc-800 z-0" />

                        {/* Step 1 */}
                        <div className="relative z-10 text-center">
                            <div className="w-24 h-24 mx-auto bg-black rounded-full border-4 border-zinc-800 flex items-center justify-center text-3xl font-black text-white mb-8 shadow-xl">
                                1
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-4">Register</h3>
                            <p className="text-zinc-400 px-4">Create your account and verify your business details.</p>
                        </div>

                        {/* Step 2 */}
                        <div className="relative z-10 text-center">
                            <div className="w-24 h-24 mx-auto bg-black rounded-full border-4 border-emerald-500 flex items-center justify-center text-3xl font-black text-emerald-500 mb-8 shadow-[0_0_30px_rgba(16,185,129,0.3)]">
                                2
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-4">Setup Venue</h3>
                            <p className="text-zinc-400 px-4">Add your sports, pricing, photos, and operating hours.</p>
                        </div>
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="text-zinc-400 px-4">Publish your page and start accepting bookings instantly.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="register" className="py-24 md:py-32 relative overflow-hidden reveal-section">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto rounded-3xl bg-zinc-900/80 border border-zinc-800 p-8 md:p-16 text-center backdrop-blur-xl">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Button className="w-full sm:w-auto px-12 py-5 text-xl font-bold rounded-full">
                                Create Partner Account
                            </Button>
                            <p className="text-zinc-500 text-sm mt-4 sm:mt-0 font-medium">
