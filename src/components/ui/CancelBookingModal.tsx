...
import { Booking } from "@/services/userData";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-[2rem] p-8 max-w-lg w-full shadow-2xl">
                ...
                <div className="mb-8 p-6 rounded-xl bg-black/40 border border-zinc-800">
                    <h3 className="text-lg font-bold text-white mb-4">{booking.venueName}</h3>
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="text-emerald-400 font-bold">LKR {booking.price.toLocaleString()}</span>
                        </div>
                    </div>
                </div>
