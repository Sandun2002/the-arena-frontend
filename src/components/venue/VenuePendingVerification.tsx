...
export default function VenuePendingVerification({ venue }: VenuePendingVerificationProps) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="w-full max-w-2xl bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-8 md:p-12 backdrop-blur-md relative overflow-hidden">
                ...
                <div className="flex flex-col items-center text-center relative z-10">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tight mb-4 leading-tight">
                    ...
                    <div className="w-full space-y-4 mb-10">
                        <div className="bg-black/40 border border-zinc-800/50 rounded-2xl p-4 flex gap-4 items-start text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <Button 
                            variant="ghost" 
                            className="text-zinc-400 hover:text-white font-bold h-12"
